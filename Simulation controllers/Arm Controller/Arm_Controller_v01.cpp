...
using namespace webots;
  ...
  double armrotate = 0.0;
  double catchRight = 0.0;
  double catchLeft = 0.0;
  ...
  char armMotorNames[6][20] = {"linear motor","rotational motor1","cmBase","camMotor","rotational motor2","rotational motor3"};
   ...
   while (robot->step(TIME_STEP) != -1) {
          ...
          //////////////////////// Rotate arm up and down ///////////////////////
            ...
            if(key == 70 && armrotate <1.57){
              armrotate += 0.1;
              }
            else if(key == 82 && armrotate >-1.57){
              armrotate += -0.1; 
              }
            else {
              armrotate +=0; 
            ...
            if(key == 84 && catchRight <1.57){
              catchRight += 0.1;
              }
            else if(key == 71 && catchRight >-1.57){
              catchRight += -0.1; 
              }
            else {
              catchRight +=0; 
